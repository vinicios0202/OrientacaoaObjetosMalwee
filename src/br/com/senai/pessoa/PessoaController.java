...
public class PessoaController {
	...
	public List<Pessoa> listarPessoas(List<Pessoa> pessoas) {
		...
		System.out.printf(
				"| %2s | %8s | %4s | %5s | %6s | %6s | %5s | %15s | %3s | %15s | %12s | %26s | %15s | %7s |\n", "id",
				"Nome", "Ano", "Idade", "Altura", "Pais", "Sigla", "Estado", "UF", "Cidade", "Endereço", "Rua",
				"Complemento", "Número");
		System.out.println(
				"-----------------------------------------------------------------------------------------------------------------------------------------------------------------------");
		for (int i = 0; i < pessoas.size(); i++) {
			System.out.printf(
					"| %2d | %8s | %4d | %5d | %6.2f | %6s | %5s | %15s | %3s | %15s | %12s | %26s | %15s | %7s |\n",
					...
					pessoas.get(i).getNomeDoBairro(), pessoas.get(i).getNomeDaRua(), pessoas.get(i).getComplemento(),
